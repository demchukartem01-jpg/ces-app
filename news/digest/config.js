...
const DIGEST = {
  ...
  // Контрольные точки: за сколько дней до вступления в силу напоминать.
  // Требование всплывает только в эти дни — иначе одна и та же строка
  // висела бы в сводке месяцами и её перестали бы читать.
  CONVENTION_MILESTONES: [180, 90, 60, 30, 14, 7, 3, 1],

  // Через сколько дней ПОСЛЕ вступления в силу напомнить ещё раз —
